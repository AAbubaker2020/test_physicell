...
export default function About() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['hero', 'what-is', 'goals', 'features', 'citation', 'community']
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                { title: "Flexible", icon: FileText, description: "Adaptable to a variety of biological problems in 2D and 3D." },
        ...
        <section id="citation" className="py-20 bg-gradient-to-br from-[#E8F5E9] to-[#E3F2FD]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className="bg-white/80 backdrop-blur-sm shadow-xl transition-all duration-300 hover:shadow-2xl hover:scale-105">
