  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#E8F5E9] to-[#E3F2FD] flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-2xl font-bold mb-4 text-[#333]">Subsection Title</h3>
                <p className="text-lg mb-6 text-[#555]">
                  This is where you can add detailed content for your first section. Describe key points, features, or any other relevant information.
                </p>
                <Button className="bg-gradient-to-r from-[#4CAF50] to-[#2196F3] text-white hover:from-[#45a049] hover:to-[#1e88e5] transition-all duration-300">
                  Learn More
                </Button>
        ...
        <section id="section2" className="py-20 bg-gradient-to-br from-[#E8F5E9] to-[#E3F2FD]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.h2
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              ...
              {[1, 2, 3].map((item) => (
                ...
                >
                  <Card className="bg-white/80 backdrop-blur-sm shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105">
                    <CardHeader>
                      <CardTitle className="text-xl font-semibold text-[#333]">Card {item} Title</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <p className="text-[#555] text-lg">This is a brief description for card {item}. Add relevant content here.</p>
                    </CardContent>
                  </Card>
                </motion.div>
              ))}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <Card className="bg-gradient-to-br from-white to-[#E8F5E9] shadow-xl transition-all duration-300 hover:shadow-2xl hover:scale-105">
                  <CardHeader>
                    <CardTitle className="text-2xl font-semibold text-[#333]">Feature 1</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-[#555] text-lg mb-6">
                      Describe the first main feature or benefit here. Provide details and explain its importance.
                    </p>
              ...
              >
                <Card className="bg-gradient-to-br from-white to-[#E3F2FD] shadow-xl transition-all duration-300 hover:shadow-2xl hover:scale-105">
                  <CardHeader>
                    <CardTitle className="text-2xl font-semibold text-[#333]">Feature 2</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-[#555] text-lg mb-6">
                      Describe the second main feature or benefit here. Highlight its unique aspects and value.
                    </p>
            ...
            <div>
              ...
              <div className="flex space-x-4 mt-4">
                {[
                  ...
                  <Button key={social.name} variant="outline" size="icon" className={`bg-${social.color} text-white border-${social.color} hover:bg-${social.color} hover:text-white transition-all duration-300`}>
