        ...
        <section id="hero" className="py-20 sm:py-32 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              >
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-[#333]">Revolutionize Your Cell Modeling</h1>
                <p className="text-xl mb-8 text-[#555] max-w-2xl mx-auto lg:mx-0">PhysiCell: Advanced open-source physics-based cell simulator for cancer research and beyond</p>
                <div className="flex flex-col sm:flex-row justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  <Button variant="outline" className="border-[#2196F3] text-[#2196F3] hover:bg-[#2196F3] hover:text-white transition-all duration-300">
                    Learn More
                  </Button>
                </div>
              </motion.div>
              ...
              >
                {[
                  ...
                  <div key={index} className="relative p-2 bg-white rounded-lg shadow-md overflow-hidden group">
                    <span className="absolute top-2 left-2 bg-[#4CAF50] text-white text-xs px-2 py-1 rounded z-10">Day {item.day} - {item.cells} cells</span>
